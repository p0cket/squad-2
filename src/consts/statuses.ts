...
export const STATUS_EFFECTS: { [key: string]: StatusEffect } = {
  ...
  VULNERABLE: {
    ...
    timing: "beforeAttack",
    duration: 3,
    effectFuncName: "applyVulnerable",
    chance: 1,
    icon: "🎯",
    id: "VULNERABLE",
    notes: "Takes 50% more damage from all sources.",
  },
  THORNS: {
    name: "Thorns",
    type: "buff",
    timing: "beforeAttack",
    duration: 3,
    effectFuncName: "applyThorns",
    chance: 1,
    icon: "🌵",
    id: "THORNS",
    notes: "Attackers take 10 damage when hitting this creature.",
  },
  LEECH: {
    name: "Vampiric",
    type: "buff",
    timing: "beforeAttack",
    duration: 3,
    effectFuncName: "applyLeech",
    chance: 1,
    icon: "🩸",
    id: "LEECH",
    notes: "Heals for 30% of damage dealt.",
  },
  EVASION: {
    name: "Evasive",
    type: "buff",
    timing: "beforeAttack",
    duration: 3,
    effectFuncName: "applyEvasion",
    chance: 1,
    icon: "✨",
    id: "EVASION",
    notes: "40% chance to dodge incoming attacks.",
  },
  REFLECT: {
    name: "Reflecting",
    type: "buff",
    timing: "beforeAttack",
    duration: 3,
    effectFuncName: "applyReflect",
    chance: 1,
    icon: "🪞",
    id: "REFLECT",
    notes: "Returns 50% of damage taken back to attacker.",
  },
}
